...
# About
Demail is not a mail server. it is a compaion server that monitors an email inbox. Create rules in the form of python scripts to run in response to a received email. 
## Rules
